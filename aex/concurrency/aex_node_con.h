...
template<typename _Key,
        typename _Val,
        typename traits>
struct aex_hash_node_copy : public aex_hash_node<_Key, _Val, traits>{
    typedef _Key                                   key_type;
    typedef _Val                                   value_type;
    typedef aex_hash_node<_Key, _Val, traits>      parent;
    typedef aex_hash_node_con<_Key, _Val, traits>  self;
    ...
    //aex_hash_node_con(slot_type slot_size):parent(slot_size){init();}
    //~aex_hash_node_con(){clear();}   
    aex_hash_node_copy():parent(){};
    ~aex_hash_node_copy(){};
    aex_hash_node_copy(aex_hash_node_copy &other){
        memcpy(this, &other, sizeof(self));
    }
    aex_hash_node_copy& operator = (aex_hash_node_copy &other){
        memcpy(this, &other, sizeof(self));
        return *this;
    }
