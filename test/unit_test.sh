...
./unit_test --unit=model --key_type=float --num_keys=1000000 --model_type=piecewise_linear --input_file=/home/zzr/data/generate_data/uniform_1M_neg100to100_float.bin
